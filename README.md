...
| NC.io (1)   | [20. Valid Parentheses](https://leetcode.com/problems/valid-parentheses/) 🟢 | [Code](https://github.com/milosarsik/Python-Interview-Preparation/blob/main/LeetCode/Stacks/Easy/ValidParentheses.py) | :heavy_check_mark: |  <br/>Time Complexity: O(n)<br/>Space Complexity: O(1) | [Video](https://www.youtube.com/watch?v=WTzjTskDFMg&ab_channel=NeetCode) |
| NC.io (2)   | [155. Min Stack](https://leetcode.com/problems/min-stack/) 🟡 | [Code](https://github.com/milosarsik/Python-Interview-Preparation/blob/main/LeetCode/Stacks/Medium/MinStack.py) | :heavy_check_mark: |  <br/>Time Complexity: O(n)<br/>Space Complexity: O(1) | [Video](https://www.youtube.com/watch?v=qkLl7nAwDPo&ab_channel=NeetCode) |
