...
| NC.io (4) | [49. Group Anagrams](https://leetcode.com/problems/group-anagrams/) (Medium) 🟡 | [Code](https://github.com/milosarsik/Python-Interview-Preparation/blob/main/LeetCode/Arrays/Medium/GroupAnagrams.py) | ✔️ | ADD |
| NC.io (5) | [347. Top K Frequent Elements](https://leetcode.com/problems/top-k-frequent-elements/description/) (Medium) 🟡 | [Code](https://github.com/milosarsik/Python-Interview-Preparation/blob/main/LeetCode/Arrays/Medium/TopKFrequentElements.py) | ✔️ | ADD |
