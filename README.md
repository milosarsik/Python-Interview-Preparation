...
| NC.io (2)   | [155. Min Stack](https://leetcode.com/problems/min-stack/) 🟡 | [Code](https://github.com/milosarsik/Python-Interview-Preparation/blob/main/LeetCode/Stacks/Medium/MinStack.py) | :heavy_check_mark: | Use two **stacks** one to store the values, the other one to store the minimum value at every new value added. <br/>Time Complexity: O(1)<br/>Space Complexity: O(1) | [Video](https://www.youtube.com/watch?v=qkLl7nAwDPo&ab_channel=NeetCode) |
