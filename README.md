...
| Problem | LeetCode | Solution  |  Completed  | Notes | Video Walkthrough |
|---------|----------|-----------|:-----------:|-------|-------------------|
| 8.1     | [165. Min Stack](https://leetcode.com/problems/min-stack/) (Easy) 🟢 | [Code]([https://github.com/milosarsik/Python-Interview-Preparation/blob/main/LeetCode/Stacks/MinStack.py](https://github.com/milosarsik/Python-Interview-Preparation/blob/main/LeetCode/Stacks/Medium/155.%20MinStack.py)) | ✔️ | Use two **stacks** one to store the values, the other one to store the minimum value at every new value added. <br/>Time Complexity: O(1) for all operations | [Video](https://www.youtube.com/watch?v=qkLl7nAwDPo&ab_channel=NeetCode) |
