...
| NC.io (9)   | [128. Longest Consecutive Sequence](https://leetcode.com/problems/longest-consecutive-sequence/description/) 🟡 | [Code](https://github.com/milosarsik/Python-Interview-Preparation/blob/main/LeetCode/Arrays/Medium/LongestConsecutiveSequence.py) | :heavy_check_mark: |  <br/>Time Complexity: O(n)<br/>Space Complexity: O(1) | [Video](https://www.youtube.com/watch?v=P6RZZMu_maU&ab_channel=NeetCode) |
